      ...
      {!isAll && (
        <span
          style={{
            ...
            height: 6,
            borderRadius: "50%",
            background: active ? m!.dot : "currentColor",
...
export default function TicketsList() {
  ...
  const displayTickets = useMemo(() => {
    ...
    if (activeStatus !== "ALL")
      list = list.filter((t: Ticket) => t.status === activeStatus);
    if (searchQuery.trim()) {
  ...
  if (error) {
    return (
      <Container py="lg">
        <CustomAlert variant="error" title="Failed to Load Tickets">
            ...
            <>
              ...
              >
                <Text size="xs" c="dimmed">
                  ...
                  tickets
                  {(searchResults !== null || activeStatus !== "ALL") &&
                    " · filtered"}
                </Text>
