      ...
      <Stack gap="lg">
        ...
        <Group justify="space-between" align="flex-end">
          <Box>
            ...
            <Text size="sm" c="dimmed" mt={2}>
              Manage ticket categories and their colors
            </Text>
          </Box>
          <Button
            size="sm"
        ...
        >
          ...
          {displayCategories.length > 0 && (
            ...
            >
              <Text size="xs" c="dimmed">
                {displayCategories.length} categor
        ...
        <Stack gap="md">
          ...
          <Box>
            ...
            <TextInput
              ...
              style={{ width: 140 }}
              styles={{
                input: { fontSize: 12, fontFamily: "monospace", height: 32 },
              }}
            />
          </Box>
          ...
          >
            <Group gap={8} align="flex-start">
              ...
              <Text size="sm" style={{ color: BRAND.redText }}>
                ...
                <strong>"{deleteConfirmName}"</strong>. Tickets using this
                category will lose their category assignment. This cannot be
                undone.
              </Text>
            </Group>
          </Paper>
