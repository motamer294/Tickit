...
# 1. Start Ollama
echo "1️⃣  Starting Ollama (LLM Engine on port 11434)..."
if lsof -i :11434 &>/dev/null; then
    echo "   ⚠️  Port 11434 already in use (Ollama might be running)"
else
...
# 2. Start FastAPI
echo "2️⃣  Starting FastAPI (ML API on port 8001)..."
