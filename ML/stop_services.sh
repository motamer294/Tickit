...
# Kill FastAPI
echo "1⃣  Stopping FastAPI (port 8001)..."
if pgrep -f "app_optimized.py" > /dev/null; then
    ...
    echo "   ℹ  FastAPI not running"
fi

echo ""

# Kill Ollama
echo "2⃣  Stopping Ollama (port 11434)..."
